...
class AudioProcessor:
    ...
    def get_transcript_path(self, audio_file: str) -> Path:
        ...
        return Path("transcripts") / f"{audio_path.stem}_transcript.txt"
...
def parse_arguments():
    ...
    parser.add_argument('--model', type=str,
                       choices=['chatgpt-4o-latest', 'o1-2024-12-17', 'o3-mini-2025-01-31' 'claude-3-sonnet-20241022'],
